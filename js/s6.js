...
s6.toggleShow = function (sel) {
  var i, x = s6.getElements(sel), l = x.length;
  for (i = 0; i < l; i++) {
...
s6.slideshow = function (sel, ms, func) {
  var i, ss, x = s6.getElements(sel), l = x.length;
  ss = {};
  ss.current = 1;
  ss.x = x;
...
s6.dataObject = {},
  s6.displayObject = function (id, data) {
    ...
    function init_template(id, obj) {
      ...
      if (s6.dataObject.hasOwnProperty(id)) { return s6.dataObject[id]; }
